...
function Icon({ children, className = 'size-6', ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function HangerIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M10 6.5a2 2 0 1 1 3 1.7c-.6.4-1 1-1 1.7V11" />
      <path d="M12 11l8.6 5.7A1.5 1.5 0 0 1 19.8 19H4.2a1.5 1.5 0 0 1-.8-2.3z" />
    </Icon>
  )
}
...
export function GridThreeIcon(props: IconProps) {
  return (
    <Icon {...props}>
...
export function GridOneIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <rect x="3" y="3" width="18" height="18" rx="2" />
      <path d="M3 12h18" />
